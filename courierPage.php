        ...
        <table width="834" border="2" align="center" cellpadding="2">
            <tbody>
                <tr>
                    ...
                    <td width="139" style="text-align: center">Job</td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: center">
                        <a href="../ManaParcelProject/control/courierFunction.php?parcelID=<?php echo $row_Recordset1['parcelID']; ?>&courierID=<?php echo $row_Recordset1['courierID']; ?>&trackID=<?php echo $row_Recordset1['trackID']; ?>&ID=<?php echo $_SESSION['ID']; ?>">Take</a>
                    </td>
                </tr>
            </tbody>
        </table>
